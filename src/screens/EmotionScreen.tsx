    ...
    <div className="fade-up">
      ...
      <div className="scroll-area" style={{ padding: "0 16px" }}>
        ...
        {step === 2 && (
          <div className="fade-up">
            <div className="ro-card" style={{ margin: "16px 0 0", borderColor: "rgba(106,90,154,0.2)" }}>
              <div className="card-title" style={{ color: "#4A3A6A" }}>La det bare være der et øyeblikk</div>
              <div className="card-sub" style={{ marginBottom: 16 }}>
                Ikke prøv å endre noe. Ikke løs noe. Bare legg merke til at det er der — og la det få lov til å eksistere.
              </div>
              <div style={{ textAlign: "center", padding: "20px 0 10px", fontSize: 32, letterSpacing: 8, opacity: 0.4 }}>· · ·</div>
